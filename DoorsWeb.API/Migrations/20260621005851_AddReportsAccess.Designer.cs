...
namespace DoorsWeb.API.Migrations
{
    ...
    [Migration("20260621005851_AddReportsAccess")]
    partial class AddReportsAccess
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.ArcCustom", b =>
                {
                    b.Property<int>("Code")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.ArcCustomFieldTypes", b =>
                {
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.ArcDoors", b =>
                {
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.ArcEvents", b =>
                {
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.ArcNameCustomFields", b =>
                {
                    b.Property<int>("CardNumber")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.ArcNameHeader", b =>
                {
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.ArcSites", b =>
                {
                    b.Property<bool?>("Inuse")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.Backup", b =>
                {
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.BioData", b =>
                {
                    b.Property<int>("Slot")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.EnterpriseData", b =>
                {
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.Modems", b =>
                {
                    b.Property<int>("Code")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.NameAccessLevelsView", b =>
                {
                    b.Property<string>("CardId")
                        .HasMaxLength(8)
                        .HasColumnType("character varying(8)")
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.NameBlankAccessLevelsView", b =>
                {
                    b.Property<string>("CardId")
                        .HasMaxLength(8)
                        .HasColumnType("character varying(8)")
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.NameHeaderView", b =>
                {
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.StatusViews", b =>
                {
                    b.Property<int>("Code")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.SystemInfo", b =>
                {
            ...
            modelBuilder.Entity("DoorsWeb.Shared.Entities.Userlog", b =>
                {
                    b.Property<string>("Key")
                        .HasMaxLength(28)
